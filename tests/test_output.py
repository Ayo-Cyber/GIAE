...
def _create_sample_genome() -> Genome:
    ...
    gene = Gene(
        name="dnaE", location=GeneLocation(start=0, end=9, strand=Strand.FORWARD), sequence="ATG"
    )
...
class TestReasoningEngine:
    def test_generate_narrative_high_confidence(self):
        ...
        assert (
            "very high confidence" in narrative.lower() or "strongly suggests" in narrative.lower()
        )
